...
You can use the output of this action to exit the workflow on cache miss. This way you can restrict your workflow to only initiate a build when a `cache-hit` occurs, in other words, if a cache with the exact key is found.
